...
all source files where taken from http://download.lulzbot.com/TAZ/6.0/. another place for source files can be found at http://devel.lulzbot.com/TAZ/Olive/
#to do
    -collect taz 6 source files-done
    -structure source files-done
